        ...
        <section class="bg0 p-t-23 p-b-140">
            <div class="container">
                <div class="flex-w flex-sb-m p-b-52">
                    <div class="flex-w flex-l-m filter-tope-group m-tb-10">
                        <a href="<?php echo e(route('Instrument.index')); ?>">
                            <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 <?php if(!request()->categorie): ?> <?php echo e("how-active1"); ?><?php endif; ?>" data-filter="*">
                                Tous les produits
                            </button>
                        </a>
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categorie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href=<?php echo e(route('Instrument.index', ['categorie' => $categorie->idCategorie])); ?>>
                                <button type="button" class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 <?php if(request()->categorie &&  request()->categorie==$categorie->idCategorie): ?> <?php echo e("how-active1"); ?><?php endif; ?>" data-filter=".<?php echo e($categorie->libelleCategorie); ?>" >
                ...
                <?php if(Auth::check() && Auth()->user()->isAdmin): ?>
                    <a href=<?php echo e(route('Instrument.create')); ?>>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women" >
                            ...
                            <div class="block2">
                                <div class="block2-pic hov-img0">
                                    ...
                                    <img src="images/instruments/<?php echo e($instrument->imageInstrument); ?>" alt=<?php echo e($instrument->imageInstrument); ?>>
                                ...
                                <?php if(Auth::check() && Auth()->user()->isAdmin): ?>
                                    <div class="flex-r p-t-3">
                                        ...
                                        <form action="<?php echo e(route('Instrument.destroy', $instrument->idInstrument)); ?>" method="post">
                                            ...
                                            <button type="submit" name="destroy" class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11  js-show-cart">
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\MUSIC_store_V2\resources\views/Instrument/index.blade.php ENDPATH**/ ?>