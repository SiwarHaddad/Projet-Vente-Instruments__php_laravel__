                ...
                <div class="row">
                                            ...
                                            <tr class="table_row">
                                                <td class="column-1">
                                                    <div class="how-itemcart1">
                                                        <img src="images/instruments/<?php echo e($details['imageInstrument']); ?>" alt="<?php echo e($details['imageInstrument']); ?>">
                                                    </div>
                                                </td>
                                                <td class="column-2"><?php echo e(str_replace('-',' ',$details['libelleInstrument'])); ?></td>
                                                <td>&emsp;</td>
                                                <td class="column-3" colspan="2"><?php echo e($details['prixInstrument']." TND"); ?></td>
                                                <td class="column-4">
                                                    <div class="flex-w flex-r-m p-b-10">
                                                        <div class=" size-204 flex-m respon6-next">
                                                            <div class="wrap-num-product flex-w m-r-20 m-tb-10">
                                                                <input class="w-25" style="text-align:center;" value="<?php echo e($details['quantite']); ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="column-5">
                                                    ...
                                                    <?php echo e($details['prixInstrument'] * $details['quantite']); ?> TND
                                                </td>
                                                
                                                <td>
                                                    <a href="<?php echo e(route('Cart.removeItem', $id)); ?>" class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-50 js-show-cart">
                    ...
                    <div class="col-sm-10 col-lg-7 col-xl-4 m-lr-auto m-b-50">
                        <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
                            ...
                            <a href="<?php echo e(route('Commande.store')); ?>">
