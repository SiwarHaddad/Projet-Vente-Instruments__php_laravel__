...
<?php $__env->startSection('content'); ?>
    <div class="container_f">
        <form action=<?php echo e(route('User.update', Auth()->user()->idUser)); ?> method="post"  onSubmit="return validation(this)" enctype="multipart/form-data" >
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="nomUser" value="<?php echo e($user->nomUser); ?>" placeholder="votre nom" >
...
unset($__errorArgs, $__bag); ?>" id="prenomUser" value="<?php echo e($user->prenomUser); ?>" placeholder="votre prenom" >
...
unset($__errorArgs, $__bag); ?>" id="email" value="<?php echo e($user->email); ?>" placeholder="votre adresse mail" >
...
unset($__errorArgs, $__bag); ?>" id="telUser" value="<?php echo e($user->telUser); ?>" placeholder="votre tel" >
...
<?php echo $__env->make('template_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\MUSIC_store_V2\resources\views/User/edit.blade.php ENDPATH**/ ?>