...
unset($__errorArgs, $__bag); ?>" id="nom" value="<?php echo e(old('nom')); ?>" placeholder="votre nom" >
        <?php $__errorArgs = ['nom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="prenom" value="<?php echo e(old('prenom')); ?>" placeholder="votre prenom" >
...
<?php /**PATH C:\wamp64\www\MUSIC_store_V2\resources\views/Etudiant/new.blade.php ENDPATH**/ ?>